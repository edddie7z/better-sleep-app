      ...
      <div className="flex justify-center my-15">
        <div className="flex flex-col gap-15">
          <span className="text-primary w-130">
            ...
            minutes, moving through different sleep stages before starting over.
            A full night’s rest consists of multiple cycles, with deep sleep
            occurring more in the first half of the night and REM sleep
            increasing later. <br />
            <br />
            ...
            with complete cycles, reducing grogginess and improving overall rest
            quality.
          </span>
          <CycleTable />
          <Image
